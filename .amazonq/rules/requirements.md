...
### File Operations
- Generate and download CAD archives
...
### System Dependencies
- FreeCAD 0.20 for CAD operations
...
- Performance optimization via @request_collapse decorator for caching results
...
- Bundled Python interpreter for distribution

### Backend Architecture
- All 3D operations (Visualize, CNC, Dimensions) depend on `load_all` function in `backend/api.py`
- `@request_collapse_with_progress` decorator provides caching and progress broadcasting
